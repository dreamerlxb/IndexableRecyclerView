...
public class PickCityActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("选择城市");
...
//        });
        ...
        adapter.setOnItemTitleClickListener((v, currentPosition, indexTitle) -> ToastUtil.showShort(PickCityActivity.this, "选中:" + indexTitle + "  当前位置:" + currentPosition));
        ...
        final SimpleHeaderAdapter<CityEntity> gpsHeaderAdapter = new SimpleHeaderAdapter<>(adapter, "定", "当前城市", gpsCity);
...
//        indexableLayout.showAllLetter(false);
    ...
    private List<CityEntity> initDatas() {
        List<CityEntity> list = new ArrayList<>();
        String[] cityStrings = getResources().getStringArray(R.array.city_array);
